...
public class AutoDropOffTurnLeft extends Command {
  ...
  public AutoDropOffTurnLeft(DriveSubsystem driveSubsystem, CoralSubsystem coralSubsystem, 
  AnalogInput ultraSonicSensor, AHRS navX) {
    this.driveSubsystem = driveSubsystem;
    this.coralSubsystem = coralSubsystem;
    this.ultraSonicSensor = ultraSonicSensor;
    this.navX = navX;
    this.pidControllerRight = driveSubsystem.pidControllerRightGroup;
  ...
  public void execute() {
    ...
    pidControllerRight.setReference(output, ControlType.kDutyCycle);
   ...
   while (ultraSonicSensor.getVoltage() < 1.25 && ultraSonicSensor.getVoltage() > 0.75 && finalSpeedPer > 0)
    {
      finalSpeedPer -= 0.0001;
